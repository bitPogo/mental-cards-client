...
external open class Buffer : Uint8Array {
    ...
    open fun readBigUInt64LE(offset: Number): BigInt
    open fun readBigUInt64BE(offset: Number): BigInt
    ...
    open fun readBigInt64LE(offset: Number): BigInt
    open fun readBigInt64BE(offset: Number): BigInt
    ...
    open fun writeBigUInt64LE(value: Number, offset: Number): BigInt
    open fun writeBigUInt64BE(value: Number, offset: Number): BigInt
    ...
    open fun writeBigInt64LE(value: Number, offset: Number): BigInt
    open fun writeBigInt64BE(value: Number, offset: Number): BigInt
